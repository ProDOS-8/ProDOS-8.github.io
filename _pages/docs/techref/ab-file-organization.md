...
<A NAME="B-6"><P><B>Figure B-6.  Structure of a Seedling File</B></P></A><PRE>
 ...
 $0 &#60;= EOF &#60;= $200 +-------+
</PRE><P>The file is called a seedling file because, if more than 512 data bytes are written to it, it grows into a sapling file, and thence into a tree file.</P>
